...
//     /// 新しく頂点を追加するための一時的な頂点リスト
//     /// </summary>
//     [SerializeField] public Vector3[] _tmpVertices;
//     [SerializeField] public List<Spring> _springs;
//     [SerializeField] public List<MassPoint> _massPoints;
//     [SerializeField] public bool _isFixed = false;
//     [SerializeField] public bool _isAnimatable = true;
...
//                 i++;
//             }
//             //_tmpVertices[VertexName.LeftLeg] = new Vector3(_tmpVertices[VertexName.RightPocket].x, _tmpVertices[VertexName.LeftLeg].y, _tmpVertices[VertexName.LeftLeg].z);
//             var LegLength = Vector3.Distance(_massPoints[VertexName.RightPocket]._position, _massPoints[VertexName.RightLeg]._position);
...
//             {
//                 _tmpVertices[VertexName.RightLeg] = crossLocal.normalized * LegLengthLocal + _tmpVertices[VertexName.RightPocket];
//                 //_massPoints[VertexName.LeftLeg]._position = new Vector3(_massPoints[VertexName.RightPocket]._position.x, _massPoints[VertexName.LeftLeg]._position.y, _massPoints[VertexName.LeftLeg]._position.z);
//                 _massPoints[VertexName.RightLeg]._position = cross.normalized * LegLength + _massPoints[VertexName.RightPocket]._position;
//             }
...
//         // int targetMyVertex = -1;
//         // //サブ用(予約)
//         // int targetRefVertex = -1;
//         // int checkPocketVertex = -1;
//         // int checkPocketVertex2 = -1;
//         // switch (ConnectDirectionSpring)
//         // {
//         //     case ConnectDirection.UpperRight:
//         //         //挿入ブロック(My)は右脚の質点の参照を、被挿入ブロック(Ref)の左脚の質点の参照にする
//         //         targetMyVertex = VertexName.RightLeg;
//         //         targetRefVertex = VertexName.LeftLeg;
//         //         checkPocketVertex = VertexName.RightPocket;
//         //         checkPocketVertex2 = VertexName.RightEye;
//         //         break;
//         //     case ConnectDirection.UpperLeft:
//         //         //挿入ブロック(My)は左脚の質点の参照を、被挿入ブロック(Ref)の右脚の質点の参照にする
//         //         targetMyVertex = VertexName.LeftLeg;
//         //         targetRefVertex = VertexName.RightLeg;
//         //         checkPocketVertex = VertexName.LeftPocket;
//         //         checkPocketVertex2 = VertexName.LeftEye;
//         //         break;
...
//         //     if (i == targetMyVertex)
//         //     {
//         //         _massPoints.Add(refBlock._massPoints[targetRefVertex]);
//         //     }
//         //     else
//         //     {
//         //         var massPoint = gameObject.AddComponent<MassPoint>();
...
//         //         _massPoints.Add(massPoint);
//         //         //最下層のブロックのみ固定点とする
//         //         if ((i == checkPocketVertex || i == checkPocketVertex2) && this._rootLeftPocketBlock == null)
//         //         {
//         //             massPoint._isFixed = true;
//         //         }
//         //     }
...
//         //     var initialLength = Vector3.Distance(massPoint1._position, massPoint2._position);
//         //     spring.SetSpring(massPoint1, massPoint2,
//         //     _springConstant, springLength: initialLength, _dampingConstant, 1.0f, springType: SpringType.Block);
//         //     _springs.Add(spring);
//         //     massPoint1.AddSpring(spring);
//         //     massPoint2.AddSpring(spring);
//         // }
...
//     public void InsertingToSelecting(Block selecting, ConnectDirection connectDirection)
//     {
//         //Debug.Log("connectedBlock is this " + this.ID);
//         this._leftLegInsertingBlock = selecting;
//         this._isFixed = false;
//         if (this._rightPocketInsertingBlock.Count != 0
//         && this._leftPocketInsertingBlock.Count != 0)
//         {
...
//         mesh.RecalculateNormals();
//         mesh.RecalculateTangents();
//         ReSpring(_tmpVertices, connectDirection, selecting);
//     }
//     /// <summary>
//     /// 挿入のselectingBlock側の処理
//     /// </summary>
//     public void ConnectToPreviousBlock(Block previous, ConnectDirection connectDirection)
//     {
//         //Debug.Log("selectedBlock is this " + this.ID);
//         //defaultScene.connectedBlock._leftLegInsertedBlock = this;
...
//             //this._isFixed = true;
//         }
//         this.transform.position = previous.transform.position + new Vector3(-blockVallaySize, _margin, 0);
//         UpdateMassPointPosition();
//         int i = 0;
//         foreach (var vertex in mesh.vertices)
//         {
...
//             //左足を含む面に平行に右脚の面を伸ばす
//             // 脚を曲げる
//             _tmpVertices[VertexName.LeftPocket] = (crossLocal).normalized * _margin + previous._tmpVertices[VertexName.LeftPocket];
//             _tmpVertices[VertexName.LeftLeg] = (crossLocal).normalized * LegLengthLocal + _tmpVertices[VertexName.LeftPocket];
//             _massPoints[VertexName.LeftPocket]._position = (cross).normalized * _margin + previous._massPoints[VertexName.LeftPocket]._position;
//             _massPoints[VertexName.LeftLeg]._position = (cross).normalized * LegLength + _massPoints[VertexName.LeftPocket]._position;
//             //_massPoints[VertexName.LeftLeg]._position = new Vector3(_massPoints[VertexName.LeftPocket]._position.x, _massPoints[VertexName.LeftLeg]._position.y, _massPoints[VertexName.LeftLeg]._position.z);
//         }
//         else
...
//         mesh.RecalculateNormals();
//         mesh.RecalculateTangents();
//         previous.InsertingToSelecting(this, connectDirection);
//         //TODO: 天井からつるすバネを張る
//         _massPoints[VertexName.LeftPocket]._position = (_leftPocketInsertingBlock[0]._massPoints[VertexName.RightLeg]._position - _leftPocketInsertingBlock[0]._massPoints[VertexName.RightPocket]._position).normalized * _margin + _leftPocketInsertingBlock[0]._massPoints[VertexName.RightPocket]._position;
//         _massPoints[VertexName.LeftEye]._position = (_leftPocketInsertingBlock[0]._massPoints[VertexName.RightLeg]._position - _leftPocketInsertingBlock[0]._massPoints[VertexName.RightPocket]._position).normalized * _margin + _leftPocketInsertingBlock[0]._massPoints[VertexName.RightEye]._position;
//         //TODO: バネを治す暫定的対応をちゃんと直す
